...
const BottomRight = ({
  ...
  return (
    <div className="flex items-center gap-1">
      {location.pathname.split('/')[2] === 'assignedtome' ||
      location.pathname.split('/')[2] === 'createdbyme' ||
      location.pathname.split('/')[2] === 'colleagues' ||
      location.pathname.split('/')[2] === 'finished' ||
      location.pathname.split('/')[2] === 'cancelled' ||
      location.pathname.split('/')[1] === 'myprofile' ? null : (
        <button
