  ...
  return (
    <div className="flex justify-between items-center">
      <div className="md:hidden">
        <FaBars className="cursor-pointer mr-3" size={25} onClick={toggleExtend} />
      </div>
      <div className="hidden md:block">
        {extend ? <FaChevronLeft className="cursor-pointer mr-3" size={25} onClick={toggleExtend} /> : <FaBars className="cursor-pointer mr-3" size={25} onClick={toggleExtend} />}
      </div>
